...
(function($){
	$.fn.fullScreenImage = function(imgOrigWidth, imgOrigHeight){
		...
		image.css({'position': 'fixed', 'z-index': '-10000'});
		setImageSize();
		...
		function setImageSize(){
			...
			image.css({ 'width': imgWidth+'px', 'height': imgHeight+'px', 'top': imgY+'px', 'left': imgX+'px'});
		}
